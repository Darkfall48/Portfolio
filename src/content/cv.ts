...
export const cvSections: CvSections = {
  summary: [
    ...
    {
      id: "communication",
      skills: ["saas-platforms", "powershell", "python"],
    },
  ],
  roles: [
    {
      ...
      bullets: [
        ...
        {
          id: "back-office",
          skills: ["react", "node", "mongodb", "rest", "json", "webhooks"],
        },
        {
          id: "qa-tools",
          skills: [
...
export const cvPresets: CvPreset[] = [
  {
    ...
    drop: [
      cvKey("bullet", "cyolo", "identity"),
      cvKey("bullet", "cyolo", "back-office"),
      cvKey("bullet", "cyolo", "qa-tools"),
  ...
  },
  {
    ...
    drop: [
      cvKey("bullet", "cyolo", "escalations"),
  ...
  {
    // Product ownership and IAM implementation lead; routine ticketing and
    // broad office tooling stay out of this engineering-focused document.
    id: "fullstack-iam",
    roleTerms: [
      "full-stack IAM engineer",
      "fullstack IAM engineer",
      "identity engineer",
      "IAM engineer",
      "identity integration engineer",
      "ingénieur IAM",
      "ingénieur identité",
      "מהנדס זהויות",
      "מהנדס IAM",
  ...
  {
    // Customer-facing resolution, identity, infrastructure, and automation
    // form one solutions story; deep QA tooling is reserved for IAM/full-stack.
