  ...
  return (
    <article className="profile-card">
      ...
      <nav className="profile-card-links" aria-label={t('action.contact')}>
        ...
        <a href={profile.links.linkedin} title={t('action.linkedin')} target="_blank" rel="noreferrer">
          {t('action.linkedin')}
        </a>
        <a href={profile.links.github} title={t('action.github')} target="_blank" rel="noreferrer">
          {t('action.github')}
        </a>
      </nav>
    </article>
